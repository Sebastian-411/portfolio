    ...
    <div className="skill-section">
      ...
      <ul className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-6">
        {scope.content.map((item, index) => (
          <li
            key={index}
            className="flex items-center space-x-4 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md transition-transform transform hover:scale-105 border border-gray-300"
          >
