      ...
      <div className="p-4">
        <div className="grid grid-cols-1 gap-4 list-none lg:grid-cols-3 lg:grid-rows-3 xl:grid-cols-4 xl:grid-rows-4">
          ...
          <div
            ref={refexperience}
            id="experience"
            className="ring-1 lg:row-span-2 ring-primary/5 dark:ring-white/10 lg:row-start-2  lg:gap-0 md:items-center md:gap-12  lg:col-start-2 lg:col-span-2 rounded-3xl p-8 bg-white dark:bg-secondary shadow-xl dark:shadow-thick"
          >
            <Experience />
          </div>
          <div
          ...
          <div
            ref={refprojects}
            id="projects"
            className="ring-1 lg:row-start-3 h-full flex p-8 flex-col justify-between  hover:ring-primary/5 dark:hover:ring-white/20 dark:ring-white/10 ring-primary/5 relative rounded-3xl overflow-hidden bg-white dark:bg-secondary shadow-xl dark:shadow-thick"
          >
            <Project />
          </div>
          <div
