...
export default function ExperienceCard({onClick, experience}) {
    return (
        <div>
            ...
            >
                <img src={`/experiences/${experience.title}.png`} alt={experience.title} className='group-hover:scale-125 hover:rounded-lg duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 w-full h-full group-hover:border-radius-2' />
            </div>
